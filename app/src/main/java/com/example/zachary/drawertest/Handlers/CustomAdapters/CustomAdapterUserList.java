...
import com.example.zachary.drawertest.Main.Fragments.PopUps.PopUpRateUser;
        ...
        holder.rl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (rateuser) {
                    ...
                    args.putString("UserImage", ImageHandler.DeassembleBitmaptoString(dataUser.getuserUserMain()));
