...
import com.example.zachary.drawertest.Main.Fragments.DrawerScreens.DrawerAdList;
import com.example.zachary.drawertest.Main.Fragments.DrawerScreens.DrawerCategories;
import com.example.zachary.drawertest.Main.Fragments.DrawerScreens.DrawerChatList;
import com.example.zachary.drawertest.Main.Fragments.DrawerScreens.DrawerFavourites;
import com.example.zachary.drawertest.Main.Fragments.DrawerScreens.DrawerProfile;
import com.example.zachary.drawertest.Handlers.ImageHandler;
import com.example.zachary.drawertest.Main.Settings.ChangeProfilePicture;
import com.example.zachary.drawertest.Main.Settings.Feedback;
import com.example.zachary.drawertest.R;
import com.example.zachary.drawertest.Main.Settings.Legal_Drawer;
        ...
        switch (item.getItemId()) {
            ...
            case R.id.nav_deleteall:
                ...
                if (deleteallcounter == 4) {
                    ServerInterface.sendAdDeleteAll(USRID);
                    deleteallcounter = 0;
                } else {
