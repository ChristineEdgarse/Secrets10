package com.example.zachary.drawertest.Handlers;
...
public class ImageHandler {
    ...
    public static String ImagefromStoragetoString(Intent data, int maxsize, Context context) {
        ...
        DeassembleBitmaptoString(tempbitmap);
        return bitmapstring;
    }
    ...
    public static byte[] DeassembleBitmaptoBytes(Bitmap pic) {
    ...
    public static String DeassembleBitmaptoString(Bitmap pic) {
        if (pic == null) {return null;}
        return Base64.encodeToString(DeassembleBitmaptoBytes(pic), Base64.DEFAULT);
    }
